...
viirs = {'platform_name': 'Suomi-NPP', 'format': 'RDR',
         ...
         'uri': 'ssh://{hostname}/archive/npp/RNSCA-RVIRS_npp_d20130218_t0908103_e0921256_b00001_c20130218092411165000_nfts_drl.h5'.format(hostname=hostname),
...
atms = {'platform_name': 'Suomi-NPP', 'format': 'RDR', 'start_time':
        ...
        'ssh://{hostname}/archive/npp/RATMS-RNSCA_npp_d20130218_t0908194_e0921055_b00001_c20130218092411244000_nfts_drl.h5'.format(
            hostname=hostname),
        'uid':
...
msg_terra = {"platform_name": "EOS-Terra", "uri":
             "ssh://{hostname}/archive/modis/P0420064AAAAAAAAAAAAAA14303204950001.PDS".format(hostname=hostname), "format": "PDS",
...
msg_n19 = {"platform_name": "NOAA-19", "format": "HRPT",
           ...
           "uri": "ssh://{hostname}/archive/hrpt/20141028071601_NOAA_19.hmf".format(hostname=hostname),
...
msg_m01 = {"platform_name": "Metop-B", "format": "EPS",
           ...
           "uri": "ssh://{hostname}/archive/metop/MHSx_HRP_00_M01_20141028083003Z_20141028084510Z_N_O_20141028083010Z".format(hostname=hostname),
...
msg_npp2 = {"orbit_number": 15591,
            ...
            "uri": "ssh://{hostname}//san1/polar_in/direct_readout/npp/lvl0/RCRIS-RNSCA_npp_d20141031_t0905166_e0905484_b00001_c20141031090623200000_nfts_drl.h5".format(hostname=hostname),
